...
Whoever did the awesome_nested_set plugin. This is my first plugin and I used that as a base for how to design a plugin. The Rails Way was also a great book that I essentially taught me Rails. 
